...
func NewPinataProvider(jwtToken string) *PinataProvider {
...
func (p *PinataProvider) Name() string {
	return "pinata"
}

func (p *PinataProvider) PinFile(ctx context.Context, filePath, name string) (*PinResponse, error) {
	...
	return &PinResponse{
		ID:   pinataResp.Data.ID,
		Name: pinataResp.Data.Name,
		CID:  pinataResp.Data.Cid,
		Size: pinataResp.Data.Size,
	}, nil
}

func (p *PinataProvider) UnpinFile(ctx context.Context, fileName string) error {
